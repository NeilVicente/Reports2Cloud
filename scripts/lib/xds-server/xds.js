...
var XDS = function(xdsUrl){
	this.targetDomain = xdsUrl || "http://localhost/reportsToDropbox";
	this.serverUrl = this.targetDomain + "/scripts/lib/xds-server/xds-server.html";
	this.server = false;
