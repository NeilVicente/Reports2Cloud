...
class MysqliDb
{
     ...
     * @param int $port
     */
    public function __construct($host = "localhost", $username = "root", $password = "", $db = "reports2dropbox", $port = NULL)
    {
        if ( MODE === 'live' ) {
            $db = "io4r2d_reports2dropbox";
            $username = "io4r2d_kenneth";
            $password = "kenneth__io4r2d";
        }
     ...
     */
    public function select($tableName, $numRows = null)
    {
        return $this->get($tableName, $numRows = null);
    }
